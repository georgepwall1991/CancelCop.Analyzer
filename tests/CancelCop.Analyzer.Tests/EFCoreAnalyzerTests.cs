...
{
    private static CSharpAnalyzerTest<EFCoreAnalyzer, XUnitVerifier> CreateTest(string testCode, params DiagnosticResult[] expected)
    {
        var test = new CSharpAnalyzerTest<EFCoreAnalyzer, XUnitVerifier>
        {
            TestCode = testCode,
